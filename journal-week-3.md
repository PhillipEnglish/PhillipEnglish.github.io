...
First, what is a popover?  A popover is a type of view which can be initiated in iOS where, rather than replaving a view-controller, a second view-controller appears on screen in the form of something like a speech bubble (this is as opposed to a full modal view that replaces the initial view controller).  
